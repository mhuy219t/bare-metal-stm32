...
#define APB2PERIPH_OFFSET		0x00010000U
#define APB2PERIPH_BASE_ADDR	(PERIPHERAL_BASE_ADDR + APB2PERIPH_OFFSET)
#define AHB1PERIPH_OFFSET		0x00020000U
#define AHB1PERIPH_BASE_ADDR	(PERIPHERAL_BASE_ADDR + AHB1PERIPH_OFFSET)
#define AHB2PERIPH_OFFSET		0x10000000U
#define AHB2PERIPH_BASE_ADDR	(PERIPHERAL_BASE_ADDR + AHB1PERIPH_OFFSET)
...
#define FIR_BASE_ADDR			(AHB1PERIPH_BASE_ADDR + 0x3C00)
 ...
 */
#define I2C1_PCLK_DI()		(RCC->AHB1ENR &= ~(1 << 0) )
